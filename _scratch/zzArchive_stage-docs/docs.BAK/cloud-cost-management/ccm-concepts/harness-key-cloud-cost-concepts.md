...
This section defines different Harness Cloud Cost Management (CCM) cost concepts.

### Before You Begin

* [Cloud Cost Management Overview](cloud-cost-management-overview.md)

### Node Cost

Node cost is calculated based on the public pricing API of the cloud platform.

For ECS clusters, you can replace nodes with container instances and pods with tasks.![](https://files.helpdocs.io/i5nl071jo5/articles/hs7cyi1nix/1632826292122/screenshot-2021-09-28-at-4-12-29-pm.png)Here is an example of how node cost is calculated based on the following node specification:
...
![](https://files.helpdocs.io/kw8ldg1itf/articles/eeekdk75q2/1590160575637/screenshot-2020-05-22-at-8-45-54-pm.png)Here is the formula:
...
![](https://files.helpdocs.io/i5nl071jo5/articles/hs7cyi1nix/1632827154114/screenshot-2021-09-28-at-4-35-36-pm.png)The efficiency score is the deviation of actual utilization from the expected utilization baseline.
