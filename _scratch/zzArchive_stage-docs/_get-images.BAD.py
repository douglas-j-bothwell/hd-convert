...
def getImageTarget( mdFileName, imgFileName  ):     
    mdPath, mdName = os.path.split(os.path.abspath(mdFileName))
    imgPath, imgName = os.path.split(os.path.abspath(imgFileName))

    imgPath = os.path.abspath(imgName)
    mdPath = os.path.abspath(mdFileName) 
    relPath = os.path.relpath(imgPath, mdPath)
