...
In addition to Triggers using Git providers, artifact providers, manifests, and cron scheduling, Harness includes Custom Triggers that you can use to run Pipelines via a platform-agnostic Webhook.
...
2. Click **New Trigger**, and then click **Custom**.
3. Name the new Trigger and click **Continue**.
