...
Currently, this feature is behind the feature flag `JENKINS_ARTIFACT`. Contact [Harness Support](mailto:support@harness.io) to enable the feature.Continuous Integration (CI) can be performed in Harness using the module and [CI Pipelines](/article/3amcd8hn53-ci-pipeline-basics).
