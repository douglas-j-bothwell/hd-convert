...
2. Copy the Harness account ID from the **Account Overview** of your Harness account.![](https://files.helpdocs.io/i5nl071jo5/articles/y402mpkrxq/1643000203837/screenshot-2022-01-24-at-10-24-06-am.png)
...
1. In Harness Manager, create an API token by following the instructions in [Add and Manage API Keys](/article/tdoad7xrh9-add-and-manage-api-keys).
...
![](https://files.helpdocs.io/i5nl071jo5/articles/y402mpkrxq/1643001118253/screenshot-2022-01-24-at-10-41-07-am.png)1. Click **Save**.
...
[![](https://files.helpdocs.io/kw8ldg1itf/articles/3hmfr07oz9/1586905852981/image.png)](https://files.helpdocs.io/kw8ldg1itf/articles/3hmfr07oz9/1586905852981/image.png)The most common reason is incorrect **SCIM Base URL** or **SCIM Bearer Token** settings in the OneLogin app.
...
2. Click **Users**.
3. Locate the provisioned user.![](https://files.helpdocs.io/i5nl071jo5/articles/y402mpkrxq/1643004054951/screenshot-2022-01-24-at-11-29-09-am.png)
...
You cannot provision OneLogin users to Harness User Groups if they are already provisioned in Harness. Simply remove them from Harness and then provision them using the step below.#### Add User Provisioning to the Harness OneLogin App
...
* [Permissions Reference](https://ngdocs.harness.io/article/yaornnqh0z-permissions-reference)
