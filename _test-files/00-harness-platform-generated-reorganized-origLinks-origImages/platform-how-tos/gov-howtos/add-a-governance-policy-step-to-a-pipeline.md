...
* **Account, Org, and** **Project-specific:** you can create the policy and apply it to all Pipelines in your Account, Org, and Project. The policy is evaluated on Pipeline-level events like On Run and On Save. See [Harness Governance Quickstart](/article/jws2znftay-harness-governance-quickstart).
...
* If you are new to Harness Governance, see [Harness Governance Overview](/article/1d3lmhv4jl-harness-governance-overview) and [Harness Governance Quickstart](/article/jws2znftay-harness-governance-quickstart).
...
* [Runtime Inputs](/article/f6yobn7iq0-runtime-inputs) are expanded before evaluation. You cannot perform checks to ensure a setting is always a Runtime Input, Expression, or Fixed Value.
...
![](https://files.helpdocs.io/i5nl071jo5/articles/xy8zsn8fa3/1648580307391/clean-shot-2022-03-29-at-11-58-17.png)The Policy step is added the to Stage.
...
In this example, we'll use an existing policy set. For details on creating a policy set, see [Harness Governance Quickstart](/article/jws2znftay-harness-governance-quickstart).

![](https://files.helpdocs.io/i5nl071jo5/articles/xy8zsn8fa3/1649798265792/clean-shot-2022-04-12-at-14-17-35.png)Navigate to a **Policy Set**, select it, and click **Apply**.

The Policy Set you select must be evaluated **On Step**.Currently, only the **Custom** entity type is supported. The Policy Set you select must have the **Custom** entity type selected.![](https://files.helpdocs.io/i5nl071jo5/articles/xy8zsn8fa3/1649798477801/clean-shot-2022-04-12-at-14-18-52.png)Also, select how you want the Pipeline to handle policy evaluation failures:

![](https://files.helpdocs.io/i5nl071jo5/articles/xy8zsn8fa3/1649799840390/clean-shot-2022-04-12-at-14-43-30.png)The Policy Set is added.
...
For details on how these work in Harness, See [Fixed Values, Runtime Inputs, and Expressions](/article/f6yobn7iq0-runtime-inputs).
...
![](https://files.helpdocs.io/i5nl071jo5/articles/xy8zsn8fa3/1649794193096/clean-shot-2022-04-12-at-13-09-46.png)#### Expressions
...
![](https://files.helpdocs.io/i5nl071jo5/articles/xy8zsn8fa3/1649794128602/clean-shot-2022-04-12-at-13-08-30.png)### Step 5: Test the Policy Step

New to policies and Policy Sets? See [Harness Governance Quickstart](/article/jws2znftay-harness-governance-quickstart).Let's look at an example of the Policy step.
...
You can use the following Harness expressions to output Policy Step status in a [Shell Script](/article/k5lu0u6i1i-using-shell-scripts) step:

* `<+execution.steps.[policy step Id].output.status>`
* `<+execution.steps.[policy step Id].output.policySetDetails.Example.status>`

![](https://files.helpdocs.io/i5nl071jo5/articles/xy8zsn8fa3/1652206388040/clean-shot-2022-05-10-at-11-13-01.png)For example, if the Policy Step [Id](/article/li0my8tcz3-entity-identifier-reference) is `Check`, you would reference it like this:
