...
New to Harness YAML? See [Harness YAML Quickstart](/article/1eishcolt3-harness-yaml-quickstart).In this topic:

* [Visual Summary](#visual_summary)
* [Viewing the YAML Schema](#viewing_the_yaml_schema)
* [Pipeline Studio YAML Editor](#pipeline_studio_yaml_editor)
* [Autocomplete and Command Palette](#autocomplete_and_command_palette)
...
* [Execution](#execution)
* [Steps and Step Groups](#steps_and_step_groups)
* [Fixed Value, Runtime Input, and Expression](#fixed_value_runtime_input_and_expression)
* [Flow Control](#flow_control)
* [Notification Rules](#notification_rules)
* [Triggers](#triggers)
* [Input Sets and Overlays](#input_sets_and_overlays)
...
![](https://files.helpdocs.io/i5nl071jo5/articles/xs2dfgq7s2/1642802731714/clean-shot-2022-01-21-at-14-00-58-2-x.png)### Pipeline Studio YAML Editor
...
See ​[CD Quickstarts](/category/c9j6jejsws) and [CI Quickstarts](/category/pjovrkldfq).

The YAML editor validates YAML before allowing you to save it.

To learn how to use the YAML editor, see [Harness YAML Quickstart for CD](/article/1eishcolt3-harness-yaml-quickstart).
...
![](https://files.helpdocs.io/i5nl071jo5/articles/xs2dfgq7s2/1633374117761/clean-shot-2021-10-04-at-12-01-51.png)The command palette displays the keyboard shortcuts for all commands.
...
![](https://files.helpdocs.io/i5nl071jo5/articles/xs2dfgq7s2/1633374621526/clean-shot-2021-10-04-at-12-10-14.png)### Schema Overview
...
* [Define a Failure Strategy on Stages and Steps](/article/0zvnn5s1ph-define-a-failure-strategy-on-stages-and-steps)
* [Set Execution Conditions on Stages and Steps](/article/f5y37ke7ko-set-execution-conditions-on-stages-and-steps)
...
* [Propagate and Override CD Services](/article/t57uzu1i41-propagate-and-override-cd-services)
...
* [Define Your Kubernetes Target Infrastructure](/article/0ud2ut4vt2-define-your-kubernetes-target-infrastructure)
* [Define Kubernetes Cluster Build Infrastructure](/article/x7aedul8qs-kubernetes-cluster-build-infrastructure-setup)
...
* [Viewing Execution Status](/article/aiuwxmwfe9-viewing-execution-status)
...
* [CD How-tos](/category/21a052rbi0)
...
![](https://files.helpdocs.io/i5nl071jo5/articles/xs2dfgq7s2/1633381877226/clean-shot-2021-10-04-at-14-11-09.png)See also:
...
* [Add a Pipeline Notification Strategy](/article/4bor7kyimj-notify-users-of-pipeline-events)
...
* [Connectors](/category/o1zhrfo8n5)
