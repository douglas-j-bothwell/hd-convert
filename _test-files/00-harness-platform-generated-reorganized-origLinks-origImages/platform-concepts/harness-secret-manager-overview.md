...
* See [Harness Key Concepts](/article/hv2758ro4e-learn-harness-key-concepts)
...
![](https://files.helpdocs.io/i5nl071jo5/articles/hngrlb7rd6/1618224217796/image.png)### Harness Secrets Management Process Overview
...
When you set up [Harness Git Experience](/article/utikdyxgfz-harness-git-experience-overview), you select the Connectivity Mode for Git syncing. You have two options:

* **Connect Through Manager:** Harness SaaS will connect to your Git repo whenever you make a change and Git and Harness sync.
* **Connect Through Delegate:** Harness will make all connections using the Harness Delegate. This option is used for Self-Managed Enterprise Edition frequently, but it is also used for Harness SaaS. See [Harness Self-Managed Enterprise Edition Overview](/article/tb4e039h8x-harness-on-premise-overview).
