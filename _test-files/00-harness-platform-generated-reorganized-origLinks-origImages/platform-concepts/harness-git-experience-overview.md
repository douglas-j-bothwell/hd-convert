...
* In the Git Connectors, all Projects that connect to a given Git repo must use the same Connection Type: SSH or HTTP. For more information, see [Connection Type](https://ngdocs.harness.io/article/tbm2hw6pr6-git-connector-settings-reference#connection_type).  
...
![](https://files.helpdocs.io/i5nl071jo5/articles/utikdyxgfz/1648633494976/screenshot-2022-03-30-at-3-14-07-pm.png)Whenever you commit a change to Git, Harness recieves the webhook request. This request contains details about the changes that must be applied to the Harness entities.

![](https://files.helpdocs.io/i5nl071jo5/articles/utikdyxgfz/1648634130619/screenshot-2022-03-30-at-3-24-54-pm.png)### Key Features
...
For detailed steps to add an SCM, see [Add Source Code Managers](/article/p92awqts2x-add-source-code-managers).

Any commit activities you perform when you make changes to the Project in Harness require your SCM credentials. Additional tasks, such as registering a webhook, require your Git Connector credentials.Git ConnectorA Harness Git Connector is used to sync your Harness Project with your Git repo. You can set up a [Git Connector](/category/xyexvcc206-ref-source-repo-provider) first and simply select it when setting up Git Experience, or you can create a Git Connector as part of the Git Experience setup.
...
Not sure if you are using FirstGen or NextGen? See [Harness FirstGen vs Harness NextGen](/article/1fjmm4by22).Harness NextGen Git Experience functionality is different than Harness FirstGen Harness Git Sync. If you used FirstGen Git Sync, you will find the Harness NextGen Git Experience setup and usage different and improved.
