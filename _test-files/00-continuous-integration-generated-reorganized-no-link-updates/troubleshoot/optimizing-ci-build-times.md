...
[Test Intelligence](https://ngdocs.harness.io/article/vtu9k1dsfa) dramatically improves test times by running only the tests required to confirm the quality of the code changes that triggered the CI Pipeline. 
...
* [Build and Push to Docker Registry](https://ngdocs.harness.io/article/q6fr5bj63w-build-and-push-to-docker-hub-step-settings#remote_cache_repository)
* [Build and Push to ECR](https://ngdocs.harness.io/article/aiqbxaef15-build-and-push-to-ecr-step-settings#sort=relevancy)
* [Build and Push to GCR](https://ngdocs.harness.io/article/66ykcm0sf0-build-and-push-to-gcr-step-settings#remote_cache_image)
