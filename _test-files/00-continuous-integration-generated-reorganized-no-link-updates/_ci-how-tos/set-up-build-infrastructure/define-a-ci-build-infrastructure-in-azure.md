...
Currently, this feature is behind the Feature Flag `CI_VM_INFRASTRUCTURE`. Contact [Harness Support](mailto:support@harness.io) to enable the feature.This topic describes how to set up a CI build infrastructure in Microsoft Azure. You will create a VM and install a CI Delegate and Drone Runner on it. The Delegate creates VMs dynamically in response to CI build requests.
...
![](https://files.helpdocs.io/kw8ldg1itf/articles/rhs0wi4l0q/1664893576963/azure-delegate-v-2.png)### Important Notes
...
2. In the **Pool ID**, enter the pool name `<pool_id>` that you added in [Step 2: Configure the Drone Pool](https://docs.harness.io/article/qfq7fy4cz6-draft-define-an-aws-vm-build-infrastructure-simplified#step_2_configure_the_drone_pool_on_the_aws_vm).![](https://files.helpdocs.io/kw8ldg1itf/articles/k5rvvhw49i/1661793246109/infra-setup-choose-vms.png)
