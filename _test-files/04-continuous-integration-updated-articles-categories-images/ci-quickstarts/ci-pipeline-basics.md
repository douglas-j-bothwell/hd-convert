...
See [Plugin Step Settings](../ci-technical-reference/plugin-step-settings-reference.md) and [Run a Drone Plugin in CI](../ci-how-tos/use-drone-plugins/run-a-drone-plugin-in-ci.md).
