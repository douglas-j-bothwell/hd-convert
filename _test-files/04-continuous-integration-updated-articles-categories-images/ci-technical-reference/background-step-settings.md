...
![](./static/background-step-settings-04.png)### Important Notes
...
![](./static/background-step-settings-05.png)* **ECR:** enter the FQN (fully-qualified name) of the artifact you want to deploy. Images in repos need to reference a path, for example: **40000005317.dkr.ecr.us-east-1.amazonaws.com/todolist:0.2**.
...
![](./static/background-step-settings-06.png)#### Image Pull Policy
