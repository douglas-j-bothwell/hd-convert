...
* [Before You Begin](run-a-git-hub-action-in-cie.md#before-you-begin)
* [Step 1: Create the CI Stage](run-a-git-hub-action-in-cie.md#step-1-create-the-ci-stage)
* [Step 2: Add the Codebase](run-a-git-hub-action-in-cie.md#step-2-add-the-codebase)
* [Step 3: Define the Build Farm Infrastructure](run-a-git-hub-action-in-cie.md#step-3-define-the-build-farm-infrastructure)
* [Step 4: Add the Plugin step](run-a-git-hub-action-in-cie.md#step-4-add-the-plugin-step)
* [Step 5: View the Results](run-a-git-hub-action-in-cie.md#step-5-view-the-results)
* [Configure As Code: YAML](run-a-git-hub-action-in-cie.md#configure-as-code-yaml)
* [See Also](run-a-git-hub-action-in-cie.md#see-also)
...
The `<+stage.variables.GCP_SECRET_KEY_BASE64>` setting uses a Stage variable and a Harness Secret. See [Add a Stage](https://docs.harness.io/article/2chyf1acil-add-a-stage).The above attributes of Upload Cloud Storage Action are replicated in CI Plugin Settings as follows: |

Here's an example:

![](./static/run-a-git-hub-action-in-cie-03.png)For the step settings on CI Plugins, see [Plugin Step Settings](../../ci-technical-reference/plugin-step-settings-reference.md).
