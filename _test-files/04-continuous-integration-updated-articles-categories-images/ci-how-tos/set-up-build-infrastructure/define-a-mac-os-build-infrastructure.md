...
![](./static/define-a-mac-os-build-infrastructure-18.png)### Before You Begin
...
![](./static/define-a-mac-os-build-infrastructure-19.png)In the Welcome to Anka screen, click the button for the VM you just created on the right. This opens a VNC window for the VM.

![](./static/define-a-mac-os-build-infrastructure-20.png)In the new VNC window, do the following:
...
* Run the Docker installer and accept the EULA that appears at the end of the install process.![](./static/define-a-mac-os-build-infrastructure-21.png)
...
![](./static/define-a-mac-os-build-infrastructure-22.png)Copy the binary from the Downloads folder and make sure it has the correct permissions to run. In a CLI, run the following:
