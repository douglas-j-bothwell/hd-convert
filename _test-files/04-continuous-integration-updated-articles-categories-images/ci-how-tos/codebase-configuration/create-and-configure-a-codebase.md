...
* [Before You Begin](create-and-configure-a-codebase.md#undefined)
* [Create or Edit a Codebase Connector](create-and-configure-a-codebase.md#create-or-edit-a-codebase-connector)
* [Edit Codebase Configuration](create-and-configure-a-codebase.md#edit-codebase-configuration)
	+ [Depth](create-and-configure-a-codebase.md#depth)
	+ [SSL Verify](create-and-configure-a-codebase.md#ssl-verify)
	+ [Pull Request Clone Strategy](create-and-configure-a-codebase.md#pull-request-clone-strategy)
	+ [Set Container Resources](create-and-configure-a-codebase.md#set-container-resources)
* [Troubleshooting Codebase Settings](create-and-configure-a-codebase.md#troubleshooting-codebase-settings)
* [Configure-As-Code: YAML](create-and-configure-a-codebase.md#configure-as-code-yaml)
* [See Also](create-and-configure-a-codebase.md#see-also)
...
* Increase the [Limit Memory](https://docs.harness.io/article/6vks5ym7sq-edit-a-ci-pipeline-codebase-configuration#limit_memory) of Git clone to 1 Gi.
