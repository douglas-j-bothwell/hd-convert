...
For setting up a build farm, see: [Set Up Build Infrastructure](https://docs.harness.io(https://docs.harness.io/category/set-up-build-infrastructure).
...
For details about each build and push step, see [CI Technical Reference](https://docs.harness.io(https://docs.harness.io/category/ci-technical-reference).
...
* [Set Up Build Infrastructure](https://docs.harness.io(https://docs.harness.io/category/set-up-build-infrastructure)
