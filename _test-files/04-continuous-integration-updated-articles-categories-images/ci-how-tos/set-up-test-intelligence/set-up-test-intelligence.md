...
See [Edit Codebase Configuration](../run-ci-scripts/run-a-script-in-a-ci-stage.md).
...
| **Arguments** | Enter the [arguments](../../ci-technical-reference/configure-run-tests-step-settings.md#arguments-java) for the build tool. These are used as input for the build tool choice. |
