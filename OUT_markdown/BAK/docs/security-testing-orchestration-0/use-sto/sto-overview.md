...
![](https://files.helpdocs.io/kw8ldg1itf/articles/2ap1uol6ti/1667497048580/sto-overview.png)To see all target baselines in the project, go to **Security Tests** > **Test Targets**. To see detected issues in a non-baseline target, such as a feature or developer branch, go to the build results for that target and click **Security Tests**.
