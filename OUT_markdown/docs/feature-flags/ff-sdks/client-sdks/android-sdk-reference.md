...
The current version of this SDK is **1****.****0.10.** To use this version of the SDK, you also need to use Android API level 19 or higher.### Requirements
...
* [Create a Client SDK key and make a copy of it](/article/1j7pdkqh7j-create-a-feature-flag#step_3_create_an_sdk_key).
...
3. Configure the SDK options, if needed. For more details on what features you can configure for this SDK, go to [Configure the SDK](/article/74t18egxbi-android-sdk-reference#configure_the_sdk).
...
* `YOUR_API_KEY` - The client SDK key you created when [creating the Feature Flag](/article/1j7pdkqh7j-create-a-feature-flag#step_3_create_an_sdk_key).
...
```
These methods must **not** be executed on the application's main thread as they could trigger network operations.### Listen for events
...
![](https://files.helpdocs.io/i5nl071jo5/articles/74t18egxbi/1656425256313/android-sdk.gif)### Close the SDK
