...
For more information about Targets, go to [Targeting Users With Flags](/article/xf3hmxbaji-targeting-users-with-flags).To add a Target, build it using `CfTarget.builder` and pass in arguments for the following:
