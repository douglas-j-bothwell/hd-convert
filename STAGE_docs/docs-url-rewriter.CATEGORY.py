...
JSON_file_path = "../_data/category-mappings.LATEST.json"
nginx_file_path = "../_data/_category-redirects.LATEST.txt"
...
for key, value in json_data.items():
    fromHelpDocsDomain = "https://docs.harness.io/category/" + key + "*"
    toDeveloperHubDomain = "https://developer.harness.io" + value
