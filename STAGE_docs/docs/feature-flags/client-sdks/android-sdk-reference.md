...
* [Create a Client SDK key and make a copy of it](../ff-creating-flag/create-a-feature-flag.md).
...
3. Configure the SDK options, if needed. For more details on what features you can configure for this SDK, go to [Configure the SDK](android-sdk-reference.md).
...
* `YOUR_API_KEY` - The client SDK key you created when [creating the Feature Flag](../ff-creating-flag/create-a-feature-flag.md).
