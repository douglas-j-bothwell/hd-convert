...
* [Create a server SDK key and make a copy of it](../ff-creating-flag/create-a-feature-flag.md)
...
When using your Feature Flag SDKs with a [Harness Relay Proxy](../relay-proxy/relay-proxy.md) you need to change the default ConfigURL and EventURL that we use. You can pass the URLs in when initializing the SDK, for example: 
