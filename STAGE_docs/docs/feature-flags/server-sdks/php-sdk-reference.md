...
* [Create an SDK key and make a copy of it](../ff-creating-flag/create-an-sdk-key.md)
...
For more information about Targets, see [Target Users With Flags](../ff-target-management/targeting-users-with-flags.md).To add a Target, build it and pass in arguments for the following:
